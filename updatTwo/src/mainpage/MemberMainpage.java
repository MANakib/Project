...
public class MemberMainpage extends javax.swing.JFrame {
    ...
    public MemberMainpage(Member mt) {
        initComponents();
        setResizable(false);
        setTitle("Member");
        setSize(700, 400);
        memTranfer = mt;
        //user id collect from prev 
        int temp = memTranfer.useridtransfer();
        usercollect = Integer.toString(temp);
        //JOptionPane.showMessageDialog(null, usercollect);
        welcome.setText("welcome , you are logged in");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Member Options");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MemberSearch obj = new MemberSearch();
        obj.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        MemberAccount obj = new MemberAccount(this);
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MemberMainpage(null).setVisible(true);
            }
        });
    }
